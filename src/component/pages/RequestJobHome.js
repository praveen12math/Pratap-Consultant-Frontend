...
const RequestJob = () => {
  ...
  const onSubmit = event => {
    ...
    <ToastContainer position="bottom-right" />
        ...
        <h3 className="center white-text"><b>Request for job</b></h3>
        <div className="container">
          <div className="row">
            ...
            <div className="input-field col s12">
              ...
              <input type="email" className="validate white-text"
              value={email}
            ...
            <div className="input-field col s12">
              ...
              <input type="tel" className="validate white-text"
              value={phone}
            ...
            <div className="input-field col s12">
              ...
              <input type="text" className="validate white-text" 
                value={profile}
